...
//CreateTrip
Future<ApiResponse> createTrip(MultipartFile? image,String name,String description,String subTitle,String tripContent,String itinerary,String price) async {
  ApiResponse apiResponse = ApiResponse();
  // try {
  String? token = await getToken();
  Dio dio = Dio();
