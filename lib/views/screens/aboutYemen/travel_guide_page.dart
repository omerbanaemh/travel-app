          ...
          children: [
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  const Text('معلومات مهمة عند زيارتك لليمن',textAlign: TextAlign.center,style: TextStyle(
                      fontSize: 32,
                      color: Color(0xffa76f47),
                  ),),
                  const SizedBox(height: 22,),
                  const Text('الفصول خلال السنة ',textAlign: TextAlign.center,style: TextStyle(
                      fontSize: 32,
                      color: Color(0xffa76f47),
                  ),),
                  Container(
                  ...
                  const Text('فصل الصيف ',textAlign: TextAlign.center,style: TextStyle(
                    fontSize: 32,
                  ),),
                  Container(
                    decoration: BoxDecoration(
                  ...
                  const Text('فصل الخريف ',textAlign: TextAlign.center,style: TextStyle(
                    fontSize: 32,
                  ),),
                  Container(
                    decoration: BoxDecoration(
                  ...
                  const Text('فصل الربيع ',textAlign: TextAlign.center,style: TextStyle(
                    fontSize: 32,
                  ),),
                  Container(
                    decoration: BoxDecoration(
                  ...
                  const Text('فصل الشتاء ',textAlign: TextAlign.center,style: TextStyle(
                    fontSize: 32,
                  ),),
                  Container(
                    decoration: BoxDecoration(
                  ...
                  const Text('طريقة الحصول على شريحة SIM ',style: TextStyle(
                    fontSize: 24,
                    color: Color(0xffa76f47),
                  ),),
                  const Padding(
                  ...
                  const Text('شركات الأتصالات ',style: TextStyle(
                    fontSize: 24,
                    color: Color(0xffa76f47),
                  ),),
