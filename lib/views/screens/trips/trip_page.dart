    ...
    Scaffold(
              ...
              child: Column(
                ...
                children: [
                  Stack(
                    children: [
                      Container(
                          ...
                          child: Image.network('$baseURL${trip.image}',fit: BoxFit.cover,)
                      ),
                      Positioned(
                          top: 60,
                          right: 30,
                          child: Text(trip.name,style: TextStyle(fontSize: 32,color: Color(0xffa76f47 )),))
                    ],
                  ),
                  Row(
                  ...
                  Padding(
                    ...
                    child: Text(trip.description,style: TextStyle(fontSize: 16,fontFamily: 'Tajawal'),),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(right: 16.0),
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Row(
          ...
          children: [
            Expanded(child: Text('السعر ${trip.price} ر.س', style: TextStyle(fontSize: 24,fontFamily: 'Tajawal',),)),
            SizedBox(width: 8,),
            InkWell(
              onTap: () {
                 showDialog(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  child: Center(child: Text('أحجز الآن', style: TextStyle(fontSize: 24,fontFamily: 'Tajawal',color: Colors.white),))),
            )
